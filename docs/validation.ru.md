...
Гидратация без аксессоров поддерживается только для класса запроса верхнего уровня. Вложенным DTO по-прежнему нужны сеттеры и конструктор без обязательных аргументов. Продвигаемые свойства с типом класса без аксессоров не поддерживаются. Для статических, readonly (кроме продвигаемых скалярных), асимметричных и hooked-свойств сохраняется требование аксессоров.
