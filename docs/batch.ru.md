...
- [security_hardening.md](./security_hardening.ru.md) — `max_batch_size` и другие лимиты
- [notifications.md](./notifications.ru.md) — strict vs lenient mode
- [errors.md](./errors.ru.md) — коды ошибок, формат
