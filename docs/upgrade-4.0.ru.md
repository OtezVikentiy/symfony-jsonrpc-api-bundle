...
**Что делать:**
- Поднять лимиты под конкретный профиль API. См. [security_hardening.md](./security_hardening.ru.md).
...
5. Замерить нагрузку и подкрутить лимиты под нужды ([security_hardening.md](./security_hardening.ru.md)).
