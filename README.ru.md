...
Посмотреть всё это в действии можно в демо-приложении:
[symfony-jsonrpc-api-demo](https://github.com/OtezVikentiy/symfony-jsonrpc-api-demo) —
небольшой API таск-трекера: атрибуты, DTO-валидация, батчи, версионирование,
генерация OpenAPI и маскирование логов.
...
- Панель Symfony Profiler для входящих вызовов и зарегистрированных методов
...
| [Symfony Profiler](./docs/profiler.ru.md) | Маскированные вызовы, batch-группы, время выполнения и реестр методов |
