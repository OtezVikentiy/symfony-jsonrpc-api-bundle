...
- Код и комментарии в `src/`, `tests/`, `config/` — на английском. Документация двуязычна: английская версия каждого файла основная, русская несёт суффикс `.ru.md`. Глубокие материалы в `docs/` пока только на русском, кроме гайда по переходу на 5.0.
