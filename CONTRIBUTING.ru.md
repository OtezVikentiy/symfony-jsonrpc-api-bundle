...
- Код и комментарии в `src/`, `tests/`, `config/` — на английском. Документация в `docs/`, `README.md`, `CHANGELOG.md` — на русском — английская версия каждого файла основная, русская несёт суффикс `.ru.md`.
