...
> The deep-dive documents under `docs/` are in Russian, with the exception of
> the 5.0 upgrade guide, which exists in both languages. Links below point at
> the English version wherever one exists.
...
[docs/upgrade-5.0.en.md](./docs/upgrade-5.0.en.md).
