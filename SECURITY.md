...
- **Content-Type enforcement** (с 5.0) — form-encoded/multipart запросы с телом отклоняются, закрывая CSRF-вектор через "simple request". См. [docs/upgrade-5.0.md](./docs/upgrade-5.0.md) п. 1.
